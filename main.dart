...
import 'package:medivoice/MedicineDetail.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(178, 38, 3, 99)),
        useMaterial3: true,
      ),
  ...
  children: [
    ...
    Expanded(
      child: ListView.separated(
        padding: const EdgeInsets.only(top: 10), // Add spacing from calendar
        itemBuilder: (context, index) {
          return ListTile(
            ...
            onTap: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => MedicineDetail(
...
floatingActionButton: FloatingActionButton(
    ...
    child: const Icon(Icons.add, size: 30, color: Colors.white), // Plus icon
  ),
